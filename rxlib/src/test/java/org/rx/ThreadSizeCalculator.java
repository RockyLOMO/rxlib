 ...
 */
public abstract class ThreadSizeCalculator {
    /**
     ...
     */
    private final int EPSYLON = 1000;
    /**
     * Time (millis) of the test run in the CPU time calculation.
     */
    private final long Test_Time = 3000;
    /**
    ...
    public void calculateBoundaries(BigDecimal targetUtilization, BigDecimal targetQueueSizeBytes) {
        ...
        long waittime = (Test_Time * 1000000) - cputime;
    ...
    private void calculateOptimalThreadCount(long cpu, long wait, BigDecimal targetUtilization) {
        ...
        System.out.println("Elapsed time (nanos): " + (Test_Time * 1000000));
    ...
    /**
     * Runs the {@link Runnable} over a period defined in {@link #Test_Time}.
    ...
    private void start(Runnable task) {
        ...
        do {
            ...
            timer.cancel();
        } while (Math.abs(start - Test_Time) > EPSYLON);
        collectGarbage(3);
    }
