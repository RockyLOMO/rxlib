...
public class UdpRedundantEncoder extends ChannelOutboundHandlerAdapter {
     ...
     */
    public static final int HEADER_MAGIC = 0x52444E54; // "RDNT" in ASCII
    /**
     * Header 总长度
     */
     ...
     * 自适应调整周期（秒）
     */
    public static final int ADJUST_INTERVAL_SECONDS = 2;
    public static final int DEFAULT_MAX_PENDING_DELAYED_COPIES = 4096;
    public static final int METRIC_SAMPLE_RATE = 64;
    ...
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
        ...
        if (!UdpPeerAttributes.shouldEncode(ctx.channel(), recipient)) {
            super.write(ctx, msg, promise);
            return;
        }
