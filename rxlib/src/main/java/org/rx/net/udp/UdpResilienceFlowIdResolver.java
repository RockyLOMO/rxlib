 ...
 */
public interface UdpResilienceFlowIdResolver extends Serializable {
    UdpResilienceFlowIdResolver RECIPIENT = new UdpResilienceFlowIdResolver() {
        ...
        public int resolve(Channel channel, DatagramPacket packet) {
            ...
            return UdpResilienceAttributes.addressHash(UdpResilienceAttributes.normalize(address));
        }
    };
