    ...
    private class Builder
    {
        ...
        private int fetch(State parent, List<Map.Entry<Integer, State>> siblings)
        {
            if (parent.isAcceptable())
            {
                ...
                siblings.add(new java.util.AbstractMap.SimpleEntry<Integer, State>(0, fakeNode));
            }
            for (Map.Entry<Character, State> entry : parent.getSuccess().entrySet())
            {
                siblings.add(new java.util.AbstractMap.SimpleEntry<Integer, State>(entry.getKey() + 1, entry.getValue()));
            }
        ...
        private void insert(List<Map.Entry<Integer, State>> firstSiblings)
        {
            ...
            siblingQueue.add(new java.util.AbstractMap.SimpleEntry<Integer, List<Map.Entry<Integer, State>>>(null, firstSiblings));
