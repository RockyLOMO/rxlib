...
public abstract class SuperResultSet extends SuperJdbc implements ResultSet {
    public static final SuperResultSet Empty = create(new DataTable());

    public static SuperResultSet create(DataTable dataTable) {
    ...
    public BigDecimal getBigDecimal(int columnIndex, int scale) throws SQLException {
        BigDecimal decimal = (BigDecimal) getObject(columnIndex);
        return scale != -1 ? decimal.setScale(scale) : decimal;
    }
    ...
    public Object getObject(int columnIndex) throws SQLException {
        Object val = innerGetObject(columnIndex);
        wasNull = val == null;
        return val;
    }

    protected abstract Object innerGetObject(int columnIndex) throws SQLException;
    ...
    public Reader getCharacterStream(String columnLabel) throws SQLException {
        return (Reader) getObject(findColumn(columnLabel));
    }
    ...
    public <T> T getObject(int columnIndex, Class<T> type) throws SQLException {
        return JSON.parseObject(getString(columnIndex), type);
    }
